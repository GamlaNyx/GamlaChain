...
Find a number p that when hashed with the previous block’s solution a hash with 4 leading
0s
is produced.
import hashlib
import json
...
Daniel van Flymen's image-f22a1
...
Daniel van Flymen's image-28cad8
...
Daniel van Flymen's image-eeec3
...
Daniel van Flymen's image-d8f408
...
Looking for more Blockchain articles? Subscribe to our newsletter in the footer below!

Check out our podcast on blockchain